...
python unlearn.py --epochs 10 --registered_model resnet18-mufac-3407-retrained --method our --lr 1e-5 --weight_decay 0.01 
...
# python unlearn.py --epochs 3 --registered_model vit-cifar-10-3407-retrained --batch_size 32 --method our --lr 1e-6 --weight_decay 0.01
...
# python unlearn.py --epochs 3 --registered_model vit-cifar-100-3407-retrained --batch_size 32 --method our --lr 1e-6 --weight_decay 0.01
