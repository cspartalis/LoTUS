...
python unlearn.py --epochs 3 --registered_model vit-cifar-100-12-retrained --batch_size 32 --method our --lr 1e-6 --weight_decay 0.01
...
python unlearn.py --epochs 3 --registered_model vit-mufac-12-retrained --batch_size 32 --method our --lr 1e-5 --weight_decay 0.01
...
# python unlearn.py --epochs 3 --registered_model vit-mufac-12-retrained --batch_size 16 --method amnesiac
