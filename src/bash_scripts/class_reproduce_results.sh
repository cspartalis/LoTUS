...
#   for seed in ${seeds[@]}; do
    # python retrain.py --registered_model=resnet18-cifar-10-${seed}-original --is_class_unlearning=True --class_to_forget=${class}
    # python unlearn.py --registered_model=resnet18-cifar-10-${cls}-${seed}-retrained --method=our --lr=1e-4 --alpha=32 --subset_size=0.3 --epochs=10 --is_class_unlearning=True
    # for bsl in ${baselines[@]}; do
    #   python unlearn.py --registered_model=resnet18-cifar-10-${cls}-${seed}-retrained --method=${bsl} --epochs=10
    # done
#   done
# done
...
# ================== CIFAR-100 ===================
# ###############################################
# classes=("beaver" "rocket")
# for cls in ${classes[@]}; do
#   echo "========== ${cls} - CIFAR-100 ============"
#   for seed in ${seeds[@]}; do
    # python retrain.py --registered_model=resnet18-cifar-100-${seed}-original --is_class_unlearning=True --class_to_forget=${class}
    # python unlearn.py --registered_model=resnet18-cifar-100-${cls}-${seed}-retrained --method=our --lr=1e-4 --alpha=32 --subset_size=0.3 --epochs=10 --is_class_unlearning=True
    # for bsl in ${baselines[@]}; do
    #   python unlearn.py --registered_model=resnet18-cifar-100-${cls}-${seed}-retrained --method=${bsl} --epochs=10
    # done
#   done
# done
...
# classes=("bison")
# for cls in ${classes[@]}; do
#   echo "========== ${cls} - Tiny-Imagenet ============"
#   for seed in ${seeds[@]}; do
#     # python retrain.py --registered_model=resnet18-tiny-imagenet-${seed}-original --is_class_unlearning=True --class_to_forget=${cls}
#     python unlearn.py --registered_model=resnet18-tiny-imagenet-${cls}-${seed}-retrained --method=our --lr=1e-4 --alpha=32 --subset_size=0.3 --epochs=10 --is_class_unlearning=True
#     for bsl in ${baselines[@]}; do
#       python unlearn.py --registered_model=resnet18-tiny-imagenet-${cls}-${seed}-retrained --method=${bsl} --epochs=10
#     done
#   done
# done
