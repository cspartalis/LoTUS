...
# python retrain.py --registered_model resnet18-cifar-10-3407-original
...
# python unlearn.py --registered_model resnet18-cifar-10-cat-3407-retrained --method our --lr 1e-4 --weight_decay 0.001
...
# python unlearn.py --epochs 10 --registered_model resnet18-cifar-10-cat-3407-retrained --method boundary
...
# python unlearn.py --registered_model resnet18-cifar-10-horse-3407-retrained --method our --lr 1e-4 --weight_decay 0.001
...
python unlearn.py --epochs 10 --registered_model resnet18-mufac-3407-retrained --method boundary
