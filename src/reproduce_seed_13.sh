...
python unlearn.py --epochs 10 --registered_model resnet18-mufac-13-retrained --method our --lr 1e-4 --weight_decay 0.1 
...
# python unlearn.py --epochs 3 --registered_model vit-cifar-10-13-retrained --batch_size 32 --method our --lr 1e-6 --weight_decay 0.001
...
# python unlearn.py --epochs 3 --registered_model vit-cifar-100-13-retrained --batch_size 32 --method our --lr 1e-6 --weight_decay 0.001
