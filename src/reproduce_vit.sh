...
python unlearn.py --epochs 3 --registered_model vit-cifar-100-beaver-3407-retrained --batch_size 32 --method our --lr 1e-5 --weight_decay 0.001
...
python unlearn.py --epochs 3 --registered_model vit-cifar-100-beaver-3407-retrained --batch_size 32 --method boundary
