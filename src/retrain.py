...
mlflow.log_metric("mia_bacc", mia_bacc)
...
mlflow.log_metric("original_tp", original_tp)
mlflow.log_metric("original_fn", original_fn)
mlflow.log_metric("original_tr_loss_threshold", original_tr_loss_threshold)
